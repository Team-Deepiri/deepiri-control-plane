...
echo "    ✅ All frontend submodules initialized at platform-pinned commits"
echo ""
...
echo "  - Update: git submodule update --init deepiri-web-frontend"
...
echo "  - Update API Gateway: git submodule update --init platform-services/backend/deepiri-api-gateway"
